...
if (!isset($CURUSER) || ($CURUSER["id"] != $row["owner"] && get_user_class() < UC_MODERATOR)) {
	...
	tr("Images", "<input type=radio name=img1action value='keep' checked>Keep Image 1  "."<input type=radio name=img1action value='delete'>Delete Image 1  "."<input type=radio name=img1action value='update'>Update Image 1<br><b>Image 1:</b>  <input type=file name=image0 size=80> <br><br> <input type=radio name=img2action value='keep' checked>Keep Image 2  "."<input type=radio name=img2action value='delete'>Delete Image 2  "."<input type=radio name=img2action value='update'>Update Image 2<br><b>Image 2:</b>  <input type=file name=image1 size=80>", 1);	
