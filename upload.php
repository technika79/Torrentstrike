...
tr("Images", "Max File Size: 500kb<br>Accepted Formats: .gif .jpg<br><b>Image 1:</b>  <input type=file name=image0 size=80><br><b>Image 2:</b>  <input type=file name=image1 size=80>\n", 1);
...
?>
<tr><td align="center" class="row2" colspan="2"><input type="submit" class="btn" value="Do it!" /><br>Click once only! - Uploading an image will require more loading time</td></tr>
<? end_table();
end_frame();
?>
</form>
