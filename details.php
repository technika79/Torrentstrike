...
//		tr("Downloads&nbsp;as", $row["save_as"]);
		...
		{
		  if ($row["image1"] != "")
		    $img1 = "<a href='viewimage.php?pic=$row[image1]'><img src='thumbnail.php?$row[image1]'></a>";
		  if ($row["image2"] != "")
		    $img2 = "<a href='viewimage.php?pic=$row[image2]'><img src='thumbnail.php?$row[image2]'></a>";
		  tr("Images", $img1 . "  " . $img2, 1);
	 }			
